      ...
      <div className="row">
        <div className="col-md-6">
          <div className={style.wrapCont}>
            ...
            <div className={style.content}>
              An automated platform for hiring purposes that makes the process
              of hiring easier than ever and helps the hiring team to make quick
              decisions. The platform identifies best-fit candidates and
              automates workflows with high-quality CV screening, interviewing,
              and assessment technology.
            </div>

            <h3 className="">Looking for a job?</h3>
            <div className={style.content}>
              If you are searching for a new career opportunity, you can search
              open vacancies and jobs.You can also signup here to be alerted of
              new jobs.
            </div>

            <h3 className="">Are you a recruiter or employer?</h3>
            <div className={style.content}>
              If you are currently hiring, and would like to advertise your jobs
              on LitFair.com, please signup for an employer account and post
              your jobs right away.
            </div>
        ...
        <div className="col-md-6 col-sm-12 col-xs-12">
          <div className={style.wrapMap}>
            <a
              href="https://goo.gl/maps/EaRpj6EqLABaKd1KA"
              target="_blank"
              rel="noreferrer"
            >
              <div id="map-tile">
